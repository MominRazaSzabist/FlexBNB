...
export default function ContactHostButton({ propertyId, propertyTitle, hostName }: ContactHostButtonProps) {
  ...
  return (
    <>
      <button
        ...
        className="flex items-center justify-center space-x-2 w-full px-6 py-3 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition font-medium"
      >
